...
myArray=[[0 for j in range(21)] for i in range(21)]
...
#Cel
    gameDisplay.fill(blue,rect=[final_point[0]*block_size,final_point[1]*block_size,block_size,block_size])
